...
public class ApiPaths {
    ...
    // search
    public static final String REGIONS_SEARCH = "/search/regions";
    public static final String CITIES_SEARCH = "/search/cities";
    public static final String CLUBS_SEARCH = "/search/clubs";
}
